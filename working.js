...
var die1, die2, dieSum, balance, banner, outcome, die1Name, die2Name, numRolls, bal; // define variables
...
function whoWon() {
  ...
  document.querySelector("h3").innerHTML = banner + "<br>" + outcome + "<br>" + bal;
}


function letsPlay() {
  numRolls = document.getElementById("val").value;//number of rolls
